...
export default function Accountingdriver() {
  ...
  return (
    <>
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">Drivers Wallet</h1>
        <p className="text-sm text-gray-500">List of all drivers wallets</p>
        ...
        <div className="flex flex-col sm:flex-row gap-2 my-5">
          <div className="bg-white rounded-lg border flex flex-col items-centre shadow w-full sm:w-1/2 py-5">
            <p className="text-sm text-gray-500  pl-5 mb-2">Total drivers wallet</p>
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 mb-4">
          ...
          <div className="relative w-[80%]  md:w-auto mt-2 md:mt-0">
            <button
              onClick={() => setStatusOpen(!statusOpen)}
              className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-300 rounded-md text-sm w-full md:w-auto"
            >
          ...
          <table className="w-full border border-gray-300 text-left ">
            ...
            <tbody >
              <tr>
                ...
                <td className="border-b px-4 py-3 text-[14px]">lagariuss</td>
